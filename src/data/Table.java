			...
			if(value>0) {	
				if(Tables.getLength()>0) {
					for(int data=0; data<Tables.getLength();data++) {
						...
						else System.out.println("Suppression de la table "+nameTable+" réuessie");
					}
				}
			}	
			if (False) {System.out.println("La table "+nameTable+" n'existe pas dans base de donnée");}	
//............................ copy DOM ........................................
				...
				System.out.println("la base de données"+nameDataBase+" n'existe pas");
		}
	}
		
		catch(Exception e) {
			Message.Alert(e.getMessage());e.getCause();
			Message.Alert("Cette base de donnée n'existe pas");
}}
